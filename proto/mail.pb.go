...
const file_proto_mail_proto_rawDesc = "" +
	...
	"\x14ListTemplatesRequest\"\x9f\x01\n" +
	"\bTemplate\x12\x0e\n" +
	...
	"\ttemplates\x18\x01 \x03(\v2\x0e.mail.TemplateR\ttemplates\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x05R\x05count2\x84\x02\n" +
	"\vMailService\x124\n" +
	...
	"\fGetAllEmails\x12\x19.mail.GetAllEmailsRequest\x1a\x1a.mail.GetAllEmailsResponse\x12H\n" +
	"\rListTemplates\x12\x1a.mail.ListTemplatesRequest\x1a\x1b.mail.ListTemplatesResponseB\fZ\n" +
...
var file_proto_mail_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_proto_mail_proto_goTypes = []any{
	...
	(*ListTemplatesRequest)(nil),  // 6: mail.ListTemplatesRequest
	(*Template)(nil),              // 7: mail.Template
	(*ListTemplatesResponse)(nil), // 8: mail.ListTemplatesResponse
	nil,                           // 9: mail.EmailRequest.TemplateDataEntry
	(*structpb.Value)(nil),        // 10: google.protobuf.Value
}
var file_proto_mail_proto_depIdxs = []int32{
	9,  // 0: mail.EmailRequest.template_data:type_name -> mail.EmailRequest.TemplateDataEntry
	4,  // 1: mail.GetAllEmailsResponse.emails:type_name -> mail.Email
	7,  // 2: mail.ListTemplatesResponse.templates:type_name -> mail.Template
	10, // 3: mail.EmailRequest.TemplateDataEntry.value:type_name -> google.protobuf.Value
	0,  // 4: mail.MailService.SendEmail:input_type -> mail.EmailRequest
	2,  // 5: mail.MailService.GetEmail:input_type -> mail.GetEmailRequest
	3,  // 6: mail.MailService.GetAllEmails:input_type -> mail.GetAllEmailsRequest
	6,  // 7: mail.MailService.ListTemplates:input_type -> mail.ListTemplatesRequest
	1,  // 8: mail.MailService.SendEmail:output_type -> mail.EmailResponse
	4,  // 9: mail.MailService.GetEmail:output_type -> mail.Email
	5,  // 10: mail.MailService.GetAllEmails:output_type -> mail.GetAllEmailsResponse
	8,  // 11: mail.MailService.ListTemplates:output_type -> mail.ListTemplatesResponse
